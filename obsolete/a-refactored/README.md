...
PASS	Authenticate the client with the server.
NICK	Set the client's nickname.
USER	Provide additional client information (username, real name, etc.).
001	Confirm successful registration.
353	List the nicknames of users in the channel.
366	Indicate the end of the list of nicknames in the channel.
461	Handle missing parameters in the JOIN command.
431	Handle cases where the client has not set a nickname before sending JOIN.
