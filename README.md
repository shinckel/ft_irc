...
| **OSI** | `Open Systems Interconnection` | Send data from one application to another application across a network. Application layer: software. Session layer: usages of OS API, interact with resources from operating system. Goes down to the physical layer: hardware. ![Screenshot 2025-05-06 at 10 22 57](https://github.com/user-attachments/assets/b95a5bfe-da84-452f-90dc-745b8ce09180) |
